...
#辅助服务市场用到的库
from service_marcket.ganshu import Transformer_asfm96,GABPNet_asfm96,XGBoost_asfm96,com_xlsx_asfm96,Auxiliary_service_asfm96
######################################################################################
import requests
import pandas as pd
"""辅助服务市场"""
def main(path_asfm96):
    ...
    """调频市场报价"""
    print('run decom_price_test_pred_asfm96 over')
    return Auxiliary_service_asfm96.asfm96() #leng=96的数组
